...
import { Settings2, History, LayoutGrid, Sliders } from 'lucide-react'
...
export function LeftPanel({ history }: { history: TextEntry[] }) {
  return (
    <Tabs defaultValue="workbench" className="flex h-full flex-col gap-0">
      <TabsList className="grid w-full grid-cols-3 rounded-none border-b border-border/50 bg-transparent p-0">
        <TabsTrigger
          value="workbench"
      ...
      <TabsContent value="settings" className="flex-1 overflow-hidden p-4">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between rounded-lg border border-border/50 bg-secondary/40 p-3">
