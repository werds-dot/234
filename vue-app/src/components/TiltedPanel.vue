...
<template>
  <div class="hidden shrink-0 md:block" style="perspective: 1600px; width: clamp(200px, 17vw, 260px)">
    <div
      class="h-full border border-border/50 bg-card/60 shadow-2xl shadow-black/50 backdrop-blur-xl"
